...
*An action potential generated by the model in response to a 2 ms current pulse (10 μA/cm², injected from t = 4 ms to t = 7 ms)*
...
- A function that finds the firing threshold and the refractory period
