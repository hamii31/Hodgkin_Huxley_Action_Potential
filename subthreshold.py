...
V_history, t_history, _, _, _ = forward_euler(T_end=T_end, dt=dt, initial_state=initial_state, I_ext_function=lambda t: threshold if 5 < t < 6 else 0)
action_potential_plot(title="Threshold Experiment", subtitle=f"The last subthreshold was observed at {threshold} µA.", V_history=V_history, t_history=t_history)
